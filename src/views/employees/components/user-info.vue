      ...
      <el-row class="inline-info">
        ...
        <el-col :span="12">
          <el-form-item label="聘用形式">
            <el-select v-model="userInfo.formatEmployment" class="inputW">
              <el-option
...
<script>
import EmployeeEnum from "@/api/constant/employees"; // 员工枚举数据
import {
  getPersonalDetail,
  updatePersonal,
  saveUserDetailById,
} from "@/api/employees"; //读取用户详情的基础信息 保存用户详情的基础信息  保存用户信息
...
export default {
  ...
  watch: {},
  created() {
    this.getUserDetailById(); //获取用户信息
    this.getPersonalDetail(); //获取基本信息
  },
  methods: {
    // 用户信息
